...
class ChatViewProvider {
    extensionUri;
    static viewType = 'aiBuddy.chatView';
    webviewView;
    client;
    conversationHistory = [];
    lastFailedContent;
    ...
    async sendActionMessage(content, queryType) {
        if (this.webviewView) {
            this.webviewView.show(true);
        }
        await this.handleUserMessage(content, queryType);
    }
    async handleInput(content, queryType) {
